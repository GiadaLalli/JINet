...
def tsne_2d_px(df, target=None, dpi=300, width=800, height=800, alpha=1, title=None, legend_orientation="v"):
...
tsne_2d_px(df, 'target', dpi=350, width=1100, height=800, alpha=0.5, title="2D t-SNE plot on Iris Data", legend_orientation="h")